...
<div class="row">
    <div class="col-md-6 col-12">
        <div class="socks-calculator-range-container">
            <input type="range" class="socks-calculator-range" id="productRange" value="25" data-tooltip-text="<?php echo __('Antal elever', 'hello-elementor'); ?>">
        </div>
    </div>
    <div class="col-md-6 col-12">
        <div class="socks-calculator-range-container">
            <input type="range" class="socks-calculator-range" id="orderRange" value="12" data-tooltip-text="<?php echo __('Sålda per elev', 'hello-elementor'); ?>">
        </div>
    </div>
</div>

<div class="profit-calculator-result">
    <h4><?php echo __('Er vinst', 'hello-elementor'); ?></h4>
